...
class App extends Component {
 //Constructor not needed anymore (automatically included in newer versions of Babel)
    // "seed" data initially
    state = {
      revenue: [
      {
  ...
  render() {
    // --> NOTE: I'm pretty sure the below calculations should go somewhere else, but I'm not quite sure where...
